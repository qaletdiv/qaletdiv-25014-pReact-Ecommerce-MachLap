                    ...
                    <nav className="header-navbar">
                        <ul className="navbar-list">
                            <li className="navbar-list__item navbar-list__item-hover ">Tải ứng dụng Chicken Cook
                                <div className="QRCode">
                                    <img src="assets/img/MyQRCode.png" alt="" className="imgQRCode" />
                                    <div className="apps">
                                        <img src="assets/img/CHPlay.png" alt="" className="chplay" />
                                        <img src="assets/img/appstore.png" alt="" className="appstore" />
                        ...
                        <ul className="navbar-list mucAn">
                            ...
                            <li className="navbar-list__item">
                                ...
                                <a href="TinTuc.html" className="item-link">Blog</a>
                            </li>
                            <li className="navbar-list__item">
